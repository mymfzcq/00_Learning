...
namespace PMU
{
    ...
    volatile uint32 PerformanceCPUJCP2016::u32BenchMarkCounters = 0;
    PerformanceCPUJCP2016 *PerformanceCPUJCP2016::poPerformanceCPUJCP2016 = NULL;

    void PerformanceCPUJCP2016::vInit(void)
    {
        uint8 u8ErrorCnt = 0;
        poPerformanceCPUJCP2016 = new PerformanceCPUJCP2016(u8ErrorCnt);
        if (poPerformanceCPUJCP2016 == NULL || u8ErrorCnt > 0)
        {
            vGoFailure();
        }
    }

    void PerformanceCPUJCP2016::vDeInit(void)
    {

    }

    PerformanceCPUJCP2016::PerformanceCPUJCP2016(uint8 &u8ErrorCnt) :PMU_fCPU_MAX(0.0)
    {
    ...
    PerformanceCPUJCP2016::~PerformanceCPUJCP2016(void)
    {
        delete m_poStatistics;
    }

    PerformanceCPUJCP2016 *PerformanceCPUJCP2016::vReturnCPUObject(void)
    {
        return poPerformanceCPUJCP2016;
    }

    uint32 PerformanceCPUJCP2016::vGetCPUBenchMarkCounter(void)
    {
        return u32BenchMarkCounters;
    }

    void PerformanceCPUJCP2016::vOutPut(void)
    {
    ...
    void PerformanceCPUJCP2016::vOutPutCPUPerf(void)
    {
#if defined JCP2016_USE_DAVE_PIPELINE
        //GAD_vJCP2016PerfCntSetMode(0,0,0);
        //GAD_vJCP2016PerfCntReset(0,1);
        //GAD_vJCP2016PerfCntReset(0,2);
        //FRT_vWaitnMicroSec(20000);
        PMU::JCP2016GAD::PMU_vPreRecalcPrompt();
        uint32 u32ErrorCode;
        //stage1:time spend
        ...
        //stage2:cpu usage
        __DI();
        u32TempCPUCnt = PMU::PerformanceCPUJCP2016::vGetCPUBenchMarkCounter();
        ...
        __DI();
        u32TempCPUCnt = PMU::PerformanceCPUJCP2016::vGetCPUBenchMarkCounter();
        fTempCPU = (float)u32TempCPUCnt / (float)PMU_u32BenchMarkValue; //fCPUBenchMarkValue_ML_E; 
        fTempCPU *= fCPUFactor;//1.305f;
        fTempCPU = 1.0f - fTempCPU;
        fTempCPU *= 100;
        __EI();
